  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'monospace' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <button onClick={testSentryError} style={{ margin: '5px', padding: '10px' }}>
          Test Sentry Error
        </button>
        <button onClick={testSentryMessage} style={{ margin: '5px', padding: '10px' }}>
          Test Sentry Message
        </button>
        <button onClick={testLogRocketException} style={{ margin: '5px', padding: '10px' }}>
          Test LogRocket Exception
        </button>
        <button onClick={testLogRocketTag} style={{ margin: '5px', padding: '10px' }}>
          Test LogRocket Tag
        </button>
      </div>
      ...
      <div style={{ marginBottom: '20px' }}>
        <h2>API Tests</h2>
        <button onClick={testAPIError} style={{ margin: '5px', padding: '10px' }}>
          Test API Error (Sentry)
        </button>
        <button onClick={testAPISentry} style={{ margin: '5px', padding: '10px' }}>
      ...
      <div style={{ marginTop: '20px', fontSize: '12px', color: '#666' }}>
        ...
        <ul>
          ...
          <li>Check your LogRocket dashboard for session recordings and exceptions</li>
          <li>API tests will hit the backend endpoints to test server-side monitoring</li>
          <li>Make sure environment variables are configured for both services</li>
        </ul>
      </div>
    </div>
  );
