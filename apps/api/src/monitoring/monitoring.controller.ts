...
export class MonitoringController {
  ...
  @ApiOperation({ summary: 'Get resilience metrics (circuit breakers, retries)' })
  ...
  async getDatabaseMetrics() {
    return {
      timestamp: new Date().toISOString(),
      performance: await this.databasePerformanceService.getPerformanceMetrics(),
  ...
  async getSlowQueries(
    ...
    return {
      ...
      slowQueries: this.databasePerformanceService.getSlowQueries(timeRangeMs, threshold),
    };
  }
