...
@Injectable()
export abstract class EnhancedEventHandler<T extends IEvent> implements IEventHandler<T> {
  ...
  async handle(event: T): Promise<void> {
    ...
    try {
      ...
      this.logger.log(`Successfully handled event: ${eventName} in ${duration}ms`);
