...
var SentryExceptionFilter = (function () {
  ...
  var _classThis;
  var SentryExceptionFilter = (_classThis = (function () {
    function SentryExceptionFilter_1(sentryService) {
    ...
    SentryExceptionFilter_1.prototype.sanitizeHeaders = function (headers) {
