      ...
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            ...
            case 3:
              error_1 = _a.sent();
              console.error('❌ Redis connection failed:', error_1);
              throw error_1;
            case 4:
              return [2];
          }
    ...
    RedisService_1.prototype.onModuleDestroy = function () {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              if (!(this.client && this.client.isOpen)) return [3, 2];
              return [4, this.client.disconnect()];
            case 1:
              _a.sent();
      ...
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              if (!ttl) return [3, 2];
              return [4, this.client.setEx(key, ttl, value)];
            case 1:
              _a.sent();
              return [3, 4];
            case 2:
              return [4, this.client.set(key, value)];
            case 3:
              _a.sent();
              _a.label = 4;
            case 4:
    ...
    RedisService_1.prototype.exists = function (key) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, this.client.exists(key)];
            case 1:
              return [2, _a.sent()];
          }
        });
    ...
    RedisService_1.prototype.expire = function (key, seconds) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, this.client.expire(key, seconds)];
            case 1:
              result = _a.sent();
              return [2, result === 1];
          }
    ...
    RedisService_1.prototype.hGet = function (key, field) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, this.client.hGet(key, field)];
            case 1:
              result = _a.sent();
              return [
                2,
                result !== null && result !== void 0 ? result : undefined,
              ];
          }
        });
      });
    ...
    RedisService_1.prototype.hSet = function (key, field, value) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, this.client.hSet(key, field, value)];
            case 1:
              return [2, _a.sent()];
          }
        });
    ...
    RedisService_1.prototype.hGetAll = function (key) {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4, this.client.hGetAll(key)];
            case 1:
              return [2, _a.sent()];
          }
        });
