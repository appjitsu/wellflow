...
var SentryService = (function () {
  ...
  var _classThis;
  var SentryService = (_classThis = (function () {
    function SentryService_1(logRocketService) {
      this.logRocketService = logRocketService;
    }
    SentryService_1.prototype.captureException = function (error, context) {
      return __awaiter(this, void 0, void 0, function () {
        var logRocketSessionURL, logRocketError_1;
        var _a;
        return __generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              if (
                !((_a = this.logRocketService) === null || _a === void 0
                  ? void 0
                  : _a.isReady())
              )
                return [3, 4];
            ...
            case 2:
              logRocketSessionURL = _b.sent();
              this.logRocketService.captureException(error, {
                context: context,
              });
              return [3, 4];
            case 3:
              logRocketError_1 = _b.sent();
              console.warn(
                'Failed to get LogRocket session URL:',
                logRocketError_1,
              );
              return [3, 4];
            case 4:
    ...
    SentryService_1.prototype.captureMessage = function (message_1) {
      return __awaiter(
        this,
        arguments,
        void 0,
        function (message, level, context) {
          ...
          return __generator(this, function (_b) {
            if (
              ...
              try {
                this.logRocketService.log(message, level, { context: context });
    ...
    SentryService_1.prototype.startSpan = function (name, op, callback) {
      return Sentry.startSpan({ name: name, op: op }, callback);
    };
    SentryService_1.prototype.addBreadcrumb = function (breadcrumb) {
      Sentry.addBreadcrumb(breadcrumb);
    };
    SentryService_1.prototype.flush = function () {
      return __awaiter(this, arguments, void 0, function (timeout) {
        if (timeout === void 0) {
          timeout = 2000;
        }
        return __generator(this, function (_a) {
          return [2, Sentry.flush(timeout)];
        });
      });
    };
