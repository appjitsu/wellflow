...
var DatabaseService = (function () {
  ...
  var _classThis;
  var DatabaseService = (_classThis = (function () {
    function DatabaseService_1(configService) {
          ...
          switch (_a.label) {
            case 0:
              this.pool = new pg_1.Pool({
                ...
                database: this.configService.get('DB_NAME', 'wellflow'),
                max: 20,
            ...
            case 1:
              _a.trys.push([1, 3, , 4]);
              return [4, this.pool.query('SELECT 1')];
            case 2:
              _a.sent();
            ...
            case 8:
              error_2 = _a.sent();
              console.error('❌ Database table creation failed:', error_2);
              console.warn(
    ...
    DatabaseService_1.prototype.getDb = function () {
      return this.db;
    };
