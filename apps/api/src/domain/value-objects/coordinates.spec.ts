...
describe('Coordinates', () => {
  describe('constructor', () => {
    it('should create valid coordinates', () => {
      ...
      expect(coords.getLongitude()).toBe(-74.0060);
    });

    it('should throw error for invalid latitude (too high)', () => {
      expect(() => new Coordinates(91, -74.0060)).toThrow('Latitude must be between -90 and 90 degrees');
    });
    ...
    it('should throw error for invalid longitude (too high)', () => {
      expect(() => new Coordinates(40.7128, 181)).toThrow('Longitude must be between -180 and 180 degrees');
    });
  ...
  describe('distanceTo', () => {
    it('should calculate distance between two points', () => {
      const nyc = new Coordinates(40.7128, -74.0060);
    ...
    it('should return 0 for same coordinates', () => {
      const coords1 = new Coordinates(40.7128, -74.0060);
      const coords2 = new Coordinates(40.7128, -74.0060);
  ...
  describe('equals', () => {
    ...
    it('should return false for different coordinates', () => {
      const coords1 = new Coordinates(40.7128, -74.0060);
      const coords2 = new Coordinates(40.7129, -74.0060);
