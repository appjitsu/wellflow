...
Security issues: security@wellflow.com
    ...
    .setContact(
      'API Support',
      'api-support@wellflow.com',
      'support@wellflow.com',
    )
    ...
    .addTag(
      'Wells',
      'Well lifecycle management - creation, updates, status tracking',
    )
    .addTag(
      'Vendors',
    ...
    .addTag(
      'Title Management',
      'Title opinion management and curative item processing',
    )
    .addTag(
      'AFEs',
      'Authorization for Expenditure - budget management and approvals',
    )
    .addTag(
      'Lease Operating Statements',
      'Lease operating expense tracking and reporting',
    )
    .addTag(
      'Daily Drilling Reports',
      'Daily drilling operations reporting and compliance',
    )
    .addTag(
      'Maintenance Schedules',
      'Equipment maintenance scheduling and completion tracking',
    )
    ...
    .addTag(
      'Financial',
      'Financial operations - payments, cash calls, revenue distribution',
    )
    .addTag(
      'Audit',
      'Audit logging and compliance monitoring (Admin/Auditor only)',
    )
