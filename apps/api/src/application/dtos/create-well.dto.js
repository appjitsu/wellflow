...
var LocationDto = (function () {
  ...
  var _county_decorators;
  var _county_initializers = [];
  var _county_extraInitializers = [];
  ...
  return (
    (_a = (function () {
      function LocationDto() {
        ...
        this.address =
          ...
          __runInitializers(this, _address_initializers, void 0));
        this.county =
          (__runInitializers(this, _address_extraInitializers),
          __runInitializers(this, _county_initializers, void 0));
        this.state =
          (__runInitializers(this, _county_extraInitializers),
    ...
    (function () {
      ...
      __esDecorate(
        ...
        _address_initializers,
        _address_extraInitializers,
      );
      __esDecorate(
        null,
        null,
        ...
        _county_initializers,
        _county_extraInitializers,
      );
      __esDecorate(
        null,
        null,
...
var CreateWellDto = (function () {
  ...
  return (
    (_a = (function () {
      function CreateWellDto() {
        this.apiNumber = __runInitializers(
          this,
    ...
    (function () {
      ...
      _apiNumber_decorators = [
        (0, swagger_1.ApiProperty)({
          description: 'API Number (10 digits)',
          example: '4212312345',
        }),
        (0, class_validator_1.IsString)(),
      ...
      _wellType_decorators = [
        ...
        (0, class_validator_1.IsEnum)(well_status_enum_1.WellType),
      ];
...
exports.CreateWellDto = CreateWellDto;
