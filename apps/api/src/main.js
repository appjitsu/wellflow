...
var sentry_exception_filter_1 = require('./common/filters/sentry-exception.filter');
var sentry_service_1 = require('./sentry/sentry.service');
function bootstrap() {
  return __awaiter(this, void 0, void 0, function () {
    var app, sentryService, config, document, port;
    var _a;
      ...
      switch (_b.label) {
        ...
        case 1:
          ...
          app.useGlobalFilters(
            new sentry_exception_filter_1.SentryExceptionFilter(sentryService),
          );
        ...
        case 2:
          ...
          console.log(
            '\uD83D\uDCDA API documentation available at http://localhost:'.concat(
              port,
              '/api/docs',
            ),
          );
